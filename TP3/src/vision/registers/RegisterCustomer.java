...
/**
 * Menu option class for SellerMenu - RegisterCustomer
 * 
...
public class RegisterCustomer extends JPanel implements ActionListener {
    ...
    private final RegisterCustomerControl controller;
    ...
    /**
     * Adds 3 TextFields and add a new Customer to Data.
     * 
     * @see model.Customer
     * @see model.Data
     */
    public RegisterCustomer() {
        ...
        controller = new RegisterCustomerControl(this);
        ...
        JLabel labelName = new JLabel("Nome do Cliente :");
        ...
        JLabel labelCelNumber = new JLabel("Telefone :");
    ...
    public RegisterCustomerControl getController() {
        return controller;
    }
